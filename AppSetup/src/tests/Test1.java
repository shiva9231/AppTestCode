...
public class Test1 {
	...
	public static void beforeclass() throws MalformedURLException {
	 ...
	 public void registartion() {
	        ...
	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("project.labs.avviotech.com.rampg:id/countryCode")));
	        ...
	        wait = new WebDriverWait(appiumDriver, 300);
	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("project.labs.avviotech.com.rampg:id/r1"))).click();
	        /*Reeg */
