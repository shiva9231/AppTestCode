...
public class alerts {
    ...
    public void Alert() throws InterruptedException {
      ...
      */
        ...
        TouchAction talt = new TouchAction(appiumDriver);
        talt.press(PointOption.point(708, 533))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(28, 533)).release().perform();
        Thread.sleep(5000);
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/alertswicon")).click();
        Thread.sleep(2000);
        ...
        TouchAction talt1 = new TouchAction(appiumDriver);
        talt1.press(PointOption.point(708, 533))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(28, 533)).release().perform();
        Thread.sleep(5000);
