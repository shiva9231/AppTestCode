...
public class SCinsStat {
    ...
    public void insstate() throws InterruptedException {
      ...
      */
        ...
        Thread.sleep(1000);
        appiumDriver.findElement(By.xpath("//*[@text='Manage Insurance Status Info']")).click();


        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "Manage Insurance Status Info"));
        ...
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/addNew")).click();
        Thread.sleep(1000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/consumablename")).sendKeys("Transfered1");
        Thread.sleep(1000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/saveConsumable")).click();
        Thread.sleep(3000);
        // Search
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/mySearchView")).sendKeys("Transfered1");
       //Delete
        Thread.sleep(3000);
