...
public class cxsource {
    ...
    @Test
    public void cxSource() throws InterruptedException {
      ...
      */
        ...
        TouchAction tcxs = new TouchAction(appiumDriver);
        tcxs.press(PointOption.point(708, 533))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(28, 533)).release().perform();
        Thread.sleep(5000);
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/customerswicon")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/close")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/customerswicon")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/sourceEdit")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("Amico");
