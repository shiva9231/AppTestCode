...
public class SCvehcat {
    ...
    public void insstate() throws InterruptedException {
      ...
      */
        ...
        Thread.sleep(1000);
        TouchAction tvehcat = new TouchAction(appiumDriver);
        tvehcat.press(PointOption.point(517, 1087))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(517, 304)).release().perform();
        Thread.sleep(5000);
        
        appiumDriver.findElement(By.xpath("//*[@text='Manage Vehicle Category']")).click();


        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "Manage Vehicle Category"));
        ...
        TouchAction tvehcat1 = new TouchAction(appiumDriver);
        tvehcat1.press(PointOption.point(517, 1087))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(517, 304)).release().perform();
        Thread.sleep(5000);
        ...
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/addNew")).click();
        Thread.sleep(1000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/vehicle_category")).sendKeys("LGcatveh");
        Thread.sleep(2000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/submit")).click();
        Thread.sleep(2000);
        // Search
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/searchEdit")).sendKeys("LGcatveh");
        //Edit
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/editIcon")).click();
        Thread.sleep(2000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/vehicle_category")).clear();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/vehicle_category")).sendKeys("LGcatveh");
        Thread.sleep(2000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/submit")).click();
       //Delete
