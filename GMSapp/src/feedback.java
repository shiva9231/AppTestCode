...
public class feedback {
    ...
    public void feedback() throws InterruptedException {
      ...
      */
        ...
        tfbk.press(PointOption.point(708, 533))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(28, 533)).release().perform();
        Thread.sleep(5000);
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/feedbackwicon")).click();
        Thread.sleep(2000);
        appiumDriver.navigate().back();
        TouchAction tfbup = new TouchAction(appiumDriver);
        tfbup.press(PointOption.point(173, 857))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(173, 448)).release().perform();
        ...
        tfbk1.press(PointOption.point(708, 533))
	       .waitAction(waitOptions(ofMillis(1000)))
		   .moveTo(PointOption.point(28, 533)).release().perform();
        Thread.sleep(5000);
        ...
        //technician fb
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/techfeedback")).clear();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/techfeedback")).sendKeys("Good:1");
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/techrating")).click();
             wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/tv_heading"), "Rating"));
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("good");
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/tv_item")).click();
           // service fb
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/servicefeedback")).clear();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/servicefeedback")).sendKeys("Good:2");
        appiumDriver.navigate().back();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/servicerating")).click();
             wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/tv_heading"), "Rating"));
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("very good");
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/tv_item")).click();
            // customer fb
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/custfeedback")).clear();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/custfeedback")).sendKeys("Good:3");
        appiumDriver.navigate().back();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/custrating")).click();
        
             wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/tv_heading"), "Rating"));
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("Excellent");
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/tv_item")).click();
        Thread.sleep(1000);
