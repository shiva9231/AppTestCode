...
public class SCvehmod {
    ...
    public void insstate() throws InterruptedException {
      ...
      */
        ...
        appiumDriver.findElement(By.xpath("//*[@text='Manage Vehicle Models']")).click();
        
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "Manage Vehicle Models"));
        ...
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/edit"), "Add New Record"));
        Thread.sleep(2000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/brandid")).click();
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/tv_heading"), "Select Vehicle Model"));
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("Redmi");
        appiumDriver.findElement(By.xpath("//*[@text='Done']")).click();
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/modelid")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("Note5");
        appiumDriver.findElement(By.xpath("//*[@text='Done']")).click();
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/varriant")).sendKeys("testvariant");
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/saveConsumable")).click();
        Thread.sleep(2000);
        //Search
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/searchEdit")).sendKeys("Note5");
        ...
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/edit"), "Edit Record"));
        Thread.sleep(2000);
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/brandid")).click();
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/tv_heading"), "Brand"));
       appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("Redmi1");
       appiumDriver.findElement(By.xpath("//*[@text='Done']")).click();
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/modelid")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/inputSearch")).sendKeys("Note51");
        appiumDriver.findElement(By.xpath("//*[@text='Done']")).click();
        
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/varriant")).sendKeys("testvariant1");
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/saveConsumable")).click();
        Thread.sleep(2000);
