...
public class SCinvcat {
    ...
    public void insstate() throws InterruptedException {
      ...
      */
        ...
        Thread.sleep(1000);
        appiumDriver.findElement(By.xpath("//*[@text='Manage Invoicing Category Info']")).click();
        
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "Manage Invoicing Cat Info"));
        ...
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/tv_heading"), "Enter Vehicle Name"));
        appiumDriver.findElement(By.xpath("//*[@text='Spares']")).click();
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/catname")).sendKeys("LG31101");
         appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/save")).click();       
        
        //Search
        appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/searchEdit")).sendKeys("LG31101");
        Thread.sleep(1000);
        //Edit
         ...
         appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/catname")).clear();
         appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/catname")).sendKeys("LG43211");
          appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/save")).click();       
