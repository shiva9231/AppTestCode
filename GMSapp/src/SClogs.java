...
public class SClogs {
    ...
    public void insstate() throws InterruptedException {
      ...
      */
        ...
        appiumDriver.findElement(By.xpath("//*[@text='View Logs']")).click();
        
        wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "View Logs"));
