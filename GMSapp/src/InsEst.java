...
public class InsEst {
    ...
    public void estimation() throws InterruptedException {
       ...
       */
         ...
         Thread.sleep(5000);
         appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/insuranceestwicon")).click();
         Thread.sleep(2000);
         wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "Insurance Estimation"));
         //Depreciation
         appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/adddepreciation")).click();
         wait.until(ExpectedConditions.textToBe(By.id("project.labs.avviotech.com.rampg:id/titletext"), "Depreciation"));
         //Select type
         ...
         appiumDriver.findElement(By.xpath("//*[@text='Amount']")).click();
         Thread.sleep(1000);
         //Select Value
         appiumDriver.findElement(By.id("project.labs.avviotech.com.rampg:id/value")).sendKeys("50");
         Thread.sleep(2000);
         //save
